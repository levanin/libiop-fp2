...
generate_libff_Fp2_model_params((2^307)*(3^192)*119 + 1,307).print_libiop("p619+x", False)
#generate_libff_Fp_model_params((2^372)*(3^239)*701 + 1).print_libiop("p761+")
generate_libff_Fp2_model_params((2^372)*(3^239)*701 + 1,372).print_libiop("p761+x", False)
print()
